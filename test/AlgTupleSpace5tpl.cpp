...
#include <algorithms/tuples/TupleSpace5tpl.hpp>
#include <memory>
#include <vector>
...
TEST(test_algtuplespace_5tpl_classify1)
{
  ...
  std::unique_ptr<RuleAtom> atom13(new RuleAtomExact((uint16_t)99));
  ...
  assert_equal(indices[0], Generic::noRuleIsMatching(), SPOT);
  assert_equal(indices[1], (unsigned)0, SPOT);
}


TEST(test_algtuplespace_5tpl_classify2)
{
  MemChronoSetup setup;
  AlgTestFixtures::setupMemChrono(setup);
...
TEST(test_algtuplespace_5tpl_classify3)
{
  MemChronoSetup setup;
  AlgTestFixtures::setupMemChrono(setup);
  ...
  //assert_equal(packets.size(), (unsigned)1, SPOT);
  assert_equal(packets.size(), (unsigned)2, SPOT);
...
/** Test for a special case, where previous implementation failed classification.  */
TEST(test_algtuplespace_5tpl_classify4)
{
  MemChronoSetup setup;
  AlgTestFixtures::setupMemChrono(setup);
  ...
  std::unique_ptr<Rule> rule1(new Rule);
  std::unique_ptr<RuleAtom> atom11(new RuleAtomPrefix((uint32_t)0, (uint32_t)0));
  std::unique_ptr<RuleAtom> atom12(new RuleAtomPrefix((uint32_t)3521028608, (uint32_t)0xFFFFFE00));
  std::unique_ptr<RuleAtom> atom13(new RuleAtomPrefix((uint16_t)0, (uint16_t)0));
  std::unique_ptr<RuleAtom> atom14(new RuleAtomPrefix((uint16_t)0x35C0, (uint16_t)0xFFE0));
  std::unique_ptr<RuleAtom> atom15(new RuleAtomExact((uint8_t)6));
  rule1->push_back(std::move(atom11));
  rule1->push_back(std::move(atom12));
  rule1->push_back(std::move(atom13));
  ...
  std::unique_ptr<RuleAtom> atom21(new RuleAtomPrefix((uint32_t)0, (uint32_t)0));
  std::unique_ptr<RuleAtom> atom22(new RuleAtomPrefix((uint32_t)3521028608, (uint32_t)0xFFFFFE00));
  std::unique_ptr<RuleAtom> atom23(new RuleAtomPrefix((uint16_t)0, (uint16_t)0));
  std::unique_ptr<RuleAtom> atom24(new RuleAtomPrefix((uint16_t)0x2000, (uint16_t)0xFF00));
  ...
  std::unique_ptr<PacketHeaderLine> line1(new PacketHeaderLine);
  std::unique_ptr<PacketHeaderAtom> hdratom11(new PacketHeaderAtom((uint32_t)0));
  std::unique_ptr<PacketHeaderAtom> hdratom12(new PacketHeaderAtom((uint32_t)3521029119));
  std::unique_ptr<PacketHeaderAtom> hdratom13(new PacketHeaderAtom((uint32_t)65535));
  std::unique_ptr<PacketHeaderAtom> hdratom14(new PacketHeaderAtom((uint32_t)0x2017));
  std::unique_ptr<PacketHeaderAtom> hdratom15(new PacketHeaderAtom((uint32_t)6));
  line1->push_back(std::move(hdratom11));
  line1->push_back(std::move(hdratom12));
  line1->push_back(std::move(hdratom13));
...
TEST(test_algtuplespace_5tpl_classify_big)
{
  MemChronoSetup setup;
  AlgTestFixtures::setupMemChrono(setup);
...
TEST_SKIP(test_algtuplespace_5tpl_ruleadd_empty, "currently not supported")
{
  ...
  std::unique_ptr<RuleAtomExact> atom3(new RuleAtomExact((uint16_t)1024));
  std::unique_ptr<RuleAtomExact> atom4(new RuleAtomExact((uint16_t)32000));
  std::unique_ptr<RuleAtomExact> atom5(new RuleAtomExact((uint8_t)8));
  ...
  std::unique_ptr<RuleAtomExact> atom23(new RuleAtomExact((uint16_t)1024));
  std::unique_ptr<RuleAtomExact> atom24(new RuleAtomExact((uint16_t)32000));
  std::unique_ptr<RuleAtomExact> atom25(new RuleAtomExact((uint8_t)8));
  rule2.push_back(std::move(atom21));
  rule2.push_back(std::move(atom22));
  rule2.push_back(std::move(atom23));
  rule2.push_back(std::move(atom24));
...
TEST_SKIP(test_algtuplespace_5tpl_ruleadd_filled, "currently not supported")
{
  ...
  std::unique_ptr<RuleAtomRange> atom3(new RuleAtomRange((uint16_t)0, (uint16_t)0xFFFF));
  std::unique_ptr<RuleAtomRange> atom4(new RuleAtomRange((uint16_t)0, (uint16_t)0xFFFF));
  std::unique_ptr<RuleAtomRange> atom5(new RuleAtomRange((uint8_t)0, (uint8_t)0xFF));
