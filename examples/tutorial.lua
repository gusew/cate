...
addRuleToRuleset(rs, { 
	ruleAtomExact(ipv4Toi("10.0.0.20")),
	ruleAtomPrefix(ipv4Toi("10.10.100.0"), maskToi(24, 32)),
	ruleAtomExact(800), 
	ruleAtomRange(1, 0xFFFF),
	ruleAtomExact(6)
...
-- Define tests
registerBenchmark("Linear Search (5-tpl)", algLinSearch, structureIPv4, rs, headers1, 8)
registerBenchmark("Bitvector (5-tpl)", algBitvector, structureIPv4, rs, headers1, 8)
registerBenchmark("Tuple Space (5-tpl)", algTuples, structureIPv4, rs, headers1, 8)
registerBenchmark("HiCuts (5-tpl)", algHiCuts, structureIPv4, rs, headers1, 8)
